...
| Terminated              | The **contract** has been terminated for the job (business or jobseeker).  | *Reissue*, *Reopen*                | Business can reissue the application back to accepted or reopen it to the in-progress status.                                                   |
