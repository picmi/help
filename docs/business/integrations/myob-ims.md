...
|-------------------------------------------------------------------------------------------------|----------------------------------------------------|-------------------------------------------------|
| [Convert Bank Account To Simple Characters](#cfg-bank-account-simple){#cfg-bank-account-simple} | When true strips all hypens from the bank account  | True / False                                    |
...
| [Occupation Override](#cfg-occupation-override){#cfg-occupation-override}                       | Overrides the occupation based on the job title    | On/Off                                          |
| [Pay Freequency](#cfg-pay-frequency){#cfg-pay-frequency}                                        | The payment frequency                              | Weekly, Fortnightly, Hourly, Quarterly, Monthly |
...
| [Home phone](#home-phone){#home-phone}                                                          | Employee's home phone number                       | Diallable from New Zealand containing no spaces or formatting characters                                                                       | Personal Information      |
| [Occupation](#occupation){#occupation}                                                          | Employee's occupation                              | Mandatory (either Occupation or Job Title see [override](#cfg-occupation-override))                                                            | Integration Configuration |
...
| [Pay frequency](#pay-frequency){#pay-frequency}                                                 | Frequency of pay                                   | W, F, H, Q, M. Default: W. Mandatory                                                                                                           | Integration Configuration |
...
| [Bank account](#bank-account){#bank-account}                                                    | Employee's bank account number                     | Format: 00-0000-0000000-00 or 000000000000000 (digits only) depending on [Convert Bank Account To Simple Characters](#cfg-bank-account-simple) | Questions                 |
