...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Employer subsidy contribution tax rate](#cfg-subsidy-tax-rate){#cfg-subsidy-tax-rate} | Tax rate applied to employer subsidies (see [here](../guide/kiwisaver-subsidy-rates) from more) | NZ tax rates                                                                                                                                                            |
...
|----------------------------------------------------------------------------------------|-----------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| [`FirstNames`](#au-target-first-names){#au-target-first-names}                         | First Name                                          | `Worker GivenName`                                                                                             |
| [`Surname`](#au-target-surname){#au-target-surname}                                    | Surname                                             | `Worker FamilyName`                                                                                            |
| [`Birthdate`](#au-target-birthdate){#au-target-birthdate}                              | Date Of Birth                                       | Workflow question: `What is your date of birth?`                                                               |
| [`Email`](#au-target-email){#au-target-email}                                          | Email                                               | `Worker Email`                                                                                                 |
| [`Phone`](#au-target-phone){#au-target-phone}                                          | Phone Number                                        | `Worker Phone`                                                                                                 |
| [`Gender`](#au-target-gender){#au-target-gender}                                       | Gender                                              | Automatic default mapping supported; workflow question `What is your gender?`; falls back to `Not Stated`      |
| [`AddressPostal`](#au-target-address-postal){#au-target-address-postal}                | Address                                             | Workflow question: `What is your postal address?`                                                              |
| [`Title`](#au-target-title){#au-target-title}                                          | Job Title                                           | Automatic default mapping supported; falls back to the `Job Title` when building the Xero employee             |
| [`StartDate`](#au-target-start-date){#au-target-start-date}                            | Start Date                                          | `Job StartDate`                                                                                                |
| [`Remuneration`](#au-target-remuneration){#au-target-remuneration}                     | Remuneration / Pay Rate                             | Automatic default mapping supported; falls back to the `Job Remuneration` when available                       |
| [`Bank`](#au-target-bank){#au-target-bank}                                             | Bank Account BSB                                    | Workflow question: `BSB number`                                                                                |
| [`BankAccount`](#au-target-bank-account){#au-target-bank-account}                      | Bank Account Number                                 | Workflow question: `Account number`                                                                            |
| [`BankAccountName`](#au-target-bank-account-name){#au-target-bank-account-name}        | Bank Account Name                                   | Workflow question: `Your account name`                                                                         |
| [`TaxNumber`](#au-target-tax-number){#au-target-tax-number}                            | Tax Declaration / TFN                               | Workflow question: `If yes, enter your TFN`                                                                    |
| [`TaxType`](#au-target-tax-type){#au-target-tax-type}                                  | Tax Declaration / TFN Type                          | Workflow question: `Do you have a TFN?`                                                                        |
| [`TaxResidency`](#au-target-tax-residency){#au-target-tax-residency}                   | Tax Declaration / Tax Residency                     | Workflow question: `What is your tax residency status?`                                                        |
| [`TaxFree`](#au-target-tax-free){#au-target-tax-free}                                  | Tax Declaration / Tax-free threshold                | Workflow question: `Do you want to claim the tax-free threshold from this payer?`                              |
| [`TaxRepayment`](#au-target-tax-repayment){#au-target-tax-repayment}                   | Tax Declaration / Study or training loan repayments | Workflow question: `Do you have a study or training loan that requires repayments?`                            |
| [`SuperContributions`](#au-target-super-contributions){#au-target-super-contributions} | Super Fund selection                                | Workflow question: `Which super fund should we pay your superannuation contributions into?`                    |
| [`SuperName`](#au-target-super-name){#au-target-super-name}                            | Super Fund name                                     | Workflow question: `What is the name of the super fund? (Required for existing or private self-managed funds)` |
| [`SuperAccount`](#au-target-super-account){#au-target-super-account}                   | Super member or account number                      | Workflow question: `What is the member or account number for your Existing Super Fund?`                        |
| [`EmployeeId`](#au-target-employee-id){#au-target-employee-id}                         |                                                     | Manual mapping                                                                                                 |
| [`Nationality`](#au-target-nationality){#au-target-nationality}                        |                                                     | Manual mapping                                                                                                 |
| [`VisaStart`](#au-target-visa-start){#au-target-visa-start}                            |                                                     | Manual mapping                                                                                                 |
